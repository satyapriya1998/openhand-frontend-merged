...
export class AuthService {
    ...
    apiAuthRefreshTokenPost(observe?: 'body', options?: RequestOptions<'json'>): Observable<any>;
    apiAuthRefreshTokenPost(observe?: 'response', options?: RequestOptions<'json'>): Observable<HttpResponse<any>>;
    apiAuthRefreshTokenPost(observe?: 'events', options?: RequestOptions<'json'>): Observable<HttpEvent<any>>;
    apiAuthRefreshTokenPost(observe?: 'body' | 'events' | 'response', options?: RequestOptions<'arraybuffer' | 'blob' | 'json' | 'text'>): Observable<any> {
        const url = `${this.basePath}/api/Auth/refresh-token`;
